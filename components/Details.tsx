                ...
                <div className="container mx-auto py-24">
                    <div className="space-y-6">
                        <div className="flex items-center gap-x-6">
                            ...
                            >
                                <g clip-path="url(#clip0_242_12349)">
                                    <path
                    ...
                    <div className="justify-between gap-x-[54px] space-y-10 xl:flex xl:space-y-0">
                        ...
                        <div className="w-full">
                            <div className="mb-[40px] flex items-center gap-x-[6px] rounded-xl bg-[#E0E9F4] p-1">
                                <button className="w-full rounded-lg bg-white px-8 py-2 font-semibold leading-[150%] -tracking-[0.32px] text-blue-600 shadow-elevation">
                                    Deposit
                                </button>
